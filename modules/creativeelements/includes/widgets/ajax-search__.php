...
class WidgetAjaxSearch extends WidgetBase
{
    ...
    protected function render()
    {
        ...
        $this->addRenderAttribute('input', [
            ...
            'type' => 'search',
            'name' => $input_name,
            'value' => \Tools::getValue('controller') === 'search' ? \Tools::getValue($input_name) : '',
        ]);
        ?>
        <form class="elementor-search" role="search"
            action="<?= \Context::getContext()->link->getPageLink('search') ?>" method="get">
        <?php if ('topbar' === $settings['skin']) : ?>
            <div class="elementor-search__toggle">
                <i class="<?= esc_attr($settings['icon']) ?>" aria-hidden="true"></i>
                <span class="elementor-screen-only"><?= __('Search') ?></span>
            </div>
        <?php endif ?>
    ...
    {
        ?>
        <# var actionLink = <?= json_encode(\Context::getContext()->link->getPageLink('search')) ?> #>
        ...
        <# } #>
            ...
            <# if ( 'classic' === settings.skin ) { #>
                ...
                <# if ( 'icon' === settings.button_type ) { #>
                    <i class="{{ settings.icon }}" aria-hidden="true"></i>
                    <span class="elementor-screen-only"><?= __('Submit') ?></span>
