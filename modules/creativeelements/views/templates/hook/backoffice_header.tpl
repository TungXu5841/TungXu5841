...
<script type="text/html" id="tmpl-btn-edit-with-ce">
    <a href="{$edit_width_ce|escape:'html':'UTF-8'}" class="btn pointer btn-edit-with-ce"><i class="material-icons mi-ce"></i> {l s='Edit with Vec Elements' mod='creativeelements'}</a>
</script>
{/if}