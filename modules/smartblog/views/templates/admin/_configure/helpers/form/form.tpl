<div class="smartblog-module {if isset($fields[0].type) && $fields[0].type == 'normal'}nontab-content{else}tab-content{/if}" id="smartblog-admin">
{if !isset($fields[0].type) || $fields[0].type != 'normal'}    
            ...
            {foreach $fieldset.form as $key => $field}
                ...
                {elseif $key == 'input'}
                    ...
                    {foreach $field as $input}
                        ...
                        <div class="form-group {$input.name}{if isset($input.form_group_class)} {$input.form_group_class}{/if}{if $input.type == 'hidden'} hide{/if}"{if $input.name == 'id_state'} id="contains_states"{if !$contains_states} style="display:none;"{/if}{/if}{if isset($tabs) && isset($input.tab)} data-tab-id="{$input.tab}"{/if}>
                        {/if}
                        ...
                        {elseif $input.type == 'infoheading'}
                            <div class="infoheading_class col-sm-12 {if isset($input.colorclass)}{$input.colorclass}{/if} " data-name="{$input.name}" id="{$input.name}" style=" background: #eee;">
                                <h4 class="infoheading_label col-lg-offset-2" style="font-size:18px;">{$input.label}</h4>
                        ...
                        {else}
                            ...
                            {block name="field"}
                                <div class="col-lg-{if isset($input.col)}{$input.col|intval}{else}10{/if} {if !isset($input.label)}col-lg-offset-2{/if}">
                                {block name="input"}
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10">
                                            <div class="row">
                                                ...
                                                <img src="{$fields_value[$input.name]|escape:'html':'UTF-8'}" alt="" style="max-height: 100px;"/>
                                                {/if}
                                    ...
                                    <div class="image-select {if isset($input.direction)} image-select-{$input.direction}{/if}">
                                        ...
                                        {foreach $input.options.query AS $option }
                                            ...
                                            <div class="image-option">
                                                ...
                                                <img src="{$base_url}modules/smartblog/images/admin/{$option.img}" alt="{$option.name}"
