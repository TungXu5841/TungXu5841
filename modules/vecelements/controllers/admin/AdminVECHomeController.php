...
class AdminVECHomeController extends ModuleAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->_where = "AND a.type = 'page-index' AND sa.id_shop = " . (int) $this->context->shop->id;
            ...
            'fields' => [
                'CE_PAGE_INDEX' => [
                    ...
                    'list' => array_merge(
                        ...
                        VECTheme::getOptions('page-index', $this->context->language->id, $this->context->shop->id)
                    ),
                ],
            ],
            'submit' => [
        ...
        $this->name = 'AdminVECHome';
    }

    public function initToolBarTitle()
    {
        $this->page_header_toolbar_title = $this->l('Homepage Builder');
    ...
    public function renderForm()
    {
        ...
        $homeBlock = new VECTheme((int)Tools::getValue('id_vec_theme'));
        ...
        $this->fields_value['type'] = 'page-index';
