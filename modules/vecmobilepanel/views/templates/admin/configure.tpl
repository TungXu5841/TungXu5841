        ...
        <div class="tab-content row">
            <div class="panel panel-default col-lg-8 col-lg-offset-2 col-xs-12 col-xs-offset-0">
                <div class="panel-heading">
                    {l s='Customize Module Design' d='Modules.Vecmobilepanel.Admin'}
                </div>
                    ...
                    <div class="clearfix">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-3">
                                <div class="text-right">
                                    <label class="control-label">
                                        {l s='Icon color' d='Modules.Vecmobilepanel.Admin'}
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-3">
                                <div class="text-right">
                                    <label class="control-label">
                                        {l s='Show text' d='Modules.Vecmobilepanel.Admin'}
                                    </label>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-2">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-3">
                                <div class="text-right">
                                    <label class="control-label">
                                        {l s='Text color' d='Modules.Vecmobilepanel.Admin'}
                                    </label>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-2">
                ...
                <div class="panel-footer">
                    <div class="col-xs-12 text-right">
                        <button name="saveConfiguration" id="saveConfiguration" type="submit" class="btn btn-primary">{l s='Save' d='Modules.Vecmobilepanel.Admin'}</button>
                    </div>
                </div>
            </div>
        </div>
