...
<div id="blockDisplay" class="panel panel-default col-lg-8 col-xs-10 col-lg-offset-2 col-xs-offset-1 inactive">
    <div class="panel-heading">
        {l s='Mobilepanel item' d='Modules.Vecmobilepanel.Admin'}
    </div>
    ...
    {foreach from=$allblock item=$block key=$key}
        <form class="form_{$block['id_mobilepanel']}" method="post" ENCTYPE="multipart/form-data">
            <div class="panel-body-{$block['id_mobilepanel']} panel-body show-rea-block inactive">
                {* icon *}
                {include file="./config_elements/icon.tpl"}
                {* language *}
                {include file="./config_elements/language.tpl"}
    ...
    <div class="panel-footer">
        <div class="col-xs-6 text-left">
            <input name="refreshPage" type="submit"
                    class="btn btn-primary refreshPage" value="{l s='Return' d='Modules.Vecmobilepanel.Admin'}">
        </div>
        <div class="col-xs-6 text-right">
            <input name="saveContentConfiguration" id="saveContentConfiguration" data-id="" type="submit"
                   class="btn btn-primary" value="{l s='Save' d='Modules.Vecmobilepanel.Admin'}">
        </div>
    </div>
</div>
