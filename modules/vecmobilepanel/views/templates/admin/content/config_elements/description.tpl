    ...
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-3">
        <div class="text-right">
            <label class="control-label">
                {l s='Custom HTML' d='Modules.Vecmobilepanel.Admin'}
            </label>
        </div>
    </div>
        ...
        <div class="input-group col-lg-12">
            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-12">
                <textarea
                        ...
                        value="{if isset($block)}{$allblockByShop[{$language.id_lang}][$block['id_mobilepanel']]['html_content']}{/if}"
                >{if isset($block)}{$allblockByShop[{$language.id_lang}][$block['id_mobilepanel']]['html_content']}{/if}</textarea>
            </div>
        </div>
