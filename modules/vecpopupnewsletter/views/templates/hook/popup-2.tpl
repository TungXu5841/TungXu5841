<div id="vecpopupnewsletter" class="modal popup-type-2 popup-text-color-{$vecpopup.VEC_NEWSLETTER_TEXT_COLOR}" tabindex="-1" role="dialog"><div class="modal-dialog" role="document" style="{if $vecpopup.VEC_NEWSLETTER_BG == 1 && !empty($vecpopup.VEC_NEWSLETTER_BG_IMAGE)}background-image: url({$vecpopup.VEC_NEWSLETTER_BG_IMAGE});{/if}">
