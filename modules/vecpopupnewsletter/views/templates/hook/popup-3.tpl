<div id="vecpopupnewsletter" class="modal popup-type-3 popup-text-color-{$vecpopup.VEC_NEWSLETTER_TEXT_COLOR}" tabindex="-1" role="dialog"><div class="modal-dialog animationShowPopup animated" role="document">
	<div class="modal-content">
		...
		{if $vecpopup.VEC_NEWSLETTER_BG == 1 && !empty($vecpopup.VEC_NEWSLETTER_BG_IMAGE)}
			<img class="img-responsive" src="{$vecpopup.VEC_NEWSLETTER_BG_IMAGE}" alt="" title="">
		{/if}
