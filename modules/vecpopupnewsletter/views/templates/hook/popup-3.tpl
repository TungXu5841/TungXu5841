<div id="vecpopupnewsletter" class="modal popup-type-3 popup-text-color-{$vecpopup.VEC_NEWSLETTER_TEXT_COLOR}" tabindex="-1" role="dialog"><div class="modal-dialog" role="document">
