...
<div class="panel"><h3><i class="icon-list-ul"></i> {l s='Menu Item' mod='vecvegamenu'}</h3>
	...
	<div class="form-group">
		...
		<div class="col-lg-9">
			{foreach from=$languages item=language}
				...
				{/if}
			{/foreach}
			<p class="help-block" style="clear:both;">{l s='Note: If use Prestashop link and want to use Prestashop title, leave it empty.' mod='vecvegamenu'}</p>
		</div>
	</div>
	...
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='Sub Title' mod='vecvegamenu'}</label>
		<div class="col-lg-9">
			{foreach from=$languages item=language}
				{if $languages|count > 1}
					<div class="translatable-field lang-{$language.id_lang|intval}" {if $language.id_lang != $id_language}style="display:none"{/if}>
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="">{l s='Subtitle style' mod='vecvegamenu'}</label>
		<div class="col-lg-9">
			<div class="row">
	            ...
	            <div class="form-group col-lg-2">
	                <label class="control-label col-lg-6" for="subtitle_fontsize">{l s='Font size' mod='vecvegamenu'}</label>
	                <div class="col-lg-6">
	                    <div class="input-group">
	            ...
	            <div class="form-group col-lg-2">
	                <label class="control-label col-lg-6" for="subtitle_lineheight">{l s='Line height' mod='vecvegamenu'}</label>
	                <div class="col-lg-6">
	                    <div class="input-group">
	...
	<div class="form-group" id="item_type_form">
        ...
        <div class="col-lg-9">
            <select id="submenu_type" name="submenu_type" class="form-control fixed-width-lg" data-default="1">
                <option value="0" {if $menu->submenu_type == 0}selected="selected" {/if}>{l s='Mega' mod='vecvegamenu'}</option>
                <option value="1" {if $menu->submenu_type == 1}selected="selected" {/if}>{l s='Flyout' mod='vecvegamenu'}</option>
                <option value="2" {if $menu->submenu_type == 2}selected="selected" {/if}>{l s='None' mod='vecvegamenu'}</option>
            </select>
            <p class="help-block">{l s='Flyout only is available when you select category in Type Link' mod='vecvegamenu'}</p>
        </div>
    </div>
	<div class="form-group">
