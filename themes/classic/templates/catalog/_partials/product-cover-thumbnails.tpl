 ...
 *}
{if $vectheme.product_image == 'horizontal'}
  <div class="images-container js-images-container horizontal-thumb">
...
{else}
  <div class="images-container js-images-container vertical-thumb {if $vectheme.product_image == 'right'}right-position{/if}">
    {block name='product_cover'}
      <div class="product-cover">
        {if $product.default_image}
          <img
