 ...
 *}
 ...
 <div class="product-line-grid-right product-line-actions col-md-7 col-xs-12">
       <div class="row">
         <div class="col-md-4 col-xs-4 product-line-info product-price-and-shipping product-price h5 {if $product.has_discount}has-discount{/if}">
         ...
         <div class="col-md-3 col-xs-4 qty">
